...
/**
 * Servlet implementation class oid_aid_lid_searchData
 */
@WebServlet("/oid_aid_lid_searchData")
public class oid_aid_lid_searchData extends HttpServlet {
	private static final long serialVersionUID = 1L;
	DataService dataService=new DataService();
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public oid_aid_lid_searchData() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			dataList=(ArrayList<DataDisplay>) dataService.searchData(oid,aid,lid,start1,end1);
			...
			out.write(json);
			System.out.println(+1+"此线路的数据在此时间段内是："+json);
		} catch (Exception e)
		{
			// TODO 自动生成的 catch 块
			e.printStackTrace();
